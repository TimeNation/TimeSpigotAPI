...
import net.timenation.timespigotapi.manager.npc.event.PlayerNPCHideEvent;
...
import net.timenation.timespigotapi.manager.npc.modifier.EquipmentModifier;
...
import net.timenation.timespigotapi.manager.npc.modifier.RotationModifier;
import net.timenation.timespigotapi.manager.npc.modifier.TeleportModifier;
import net.timenation.timespigotapi.manager.npc.modifier.VisibilityModifier;
import net.timenation.timespigotapi.manager.npc.profile.Profile;
import net.timenation.timespigotapi.manager.npc.profile.ProfileUtils;
