package net.timenation.timespigotapi.manager.color;

import com.google.common.collect.ImmutableMap;
import net.md_5.bungee.api.ChatColor;
import net.timenation.timespigotapi.manager.color.patterns.GradientPattern;
import net.timenation.timespigotapi.manager.color.patterns.Pattern;
import net.timenation.timespigotapi.manager.color.patterns.RainbowPattern;
import net.timenation.timespigotapi.manager.color.patterns.SolidPattern;
...
public class ColorAPI {
    ...
    private final int VERSION = getVersion();
    ...
    @Nonnull
    private String withoutSpecialChar(@Nonnull String source) {
